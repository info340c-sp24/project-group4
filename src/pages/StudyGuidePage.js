...
export default function StudyGuidePage() {
    ...
    return (
            ...
            <div className="row">
                <div className="d-flex col-sm-12 col-lg-4">
                    <div className="card m-4 p-2 shadow-sm">
                        ...
                        <div className="card-footer text-center">
                            <Button type="button" variant='primary' onClick={() => setBeginnerShow(true)}>
                                Learn more
                            </Button>
                        </div>
                    </div>
                ...
                <div className="d-flex col-sm-12 col-lg-4">
                    <div className="card m-4 p-2 shadow-sm">
                        ...
                        <div className="card-footer text-center">
                            <Button type="button" variant='primary' onClick={() => setIntermediateShow(true)}>
                                Learn more
                            </Button>
                        </div>
                    </div>
                ...
                <div className="d-flex col-sm-12 col-lg-4">
                    <div className="card m-4 p-2 shadow-sm">
                        ...
                        <div className="card-footer text-center">
                            <Button type="button" variant='primary' onClick={() => setAdvancedShow(true)}>
                                Learn more
                            </Button>
                        </div>
                    </div>
        ...
        <Modal show={beginnerShow} onHide={() => setBeginnerShow(false)}>
            <Modal.Header closeButton>
                <Modal.Title>Beginner Level</Modal.Title>
            </Modal.Header>
            <Modal.Body>
            ...
            <Modal.Footer>
                <Button variant='secondary' onClick={() => setBeginnerShow(false)}>Close</Button>
            </Modal.Footer>
        </Modal>

        <Modal show={intermediateShow} onHide={() => setIntermediateShow(false)}>
            <Modal.Header closeButton>
                <Modal.Title>Intermediate Level</Modal.Title>
            </Modal.Header>
            <Modal.Body>
            ...
            <Modal.Footer>
                <Button variant='secondary' onClick={() => setIntermediateShow(false)}>Close</Button>
            </Modal.Footer>
        </Modal>
        
        <Modal show={advancedShow} onHide={() => setAdvancedShow(false)}>
            <Modal.Header closeButton>
                <Modal.Title>Advanced Level</Modal.Title>
            </Modal.Header>
            <Modal.Body>
            ...
            <Modal.Footer>
                <Button variant='secondary' onClick={() => setAdvancedShow(false)}>Close</Button>
            </Modal.Footer>
        </Modal>
    </main>
    )
